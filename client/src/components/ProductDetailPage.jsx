...
const ProductDetail = () => {
  ...
  const handleUpdateCar = async (e) => {
    ...
    try {
      ...
      updateData.append('tags', JSON.stringify(formData.tags.split(',')));
  ...
  return (
    <div className="container">
      ...
      <h4 className="mt-2 text-center">More Information about Car: {car.title}</h4>
      {car ? (
        <div className="row justify-content-center mt-5">
          <div className="col-lg-6 col-md-6 col-sm-10 col-xs-10" style={{ boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
            {carImages.length > 0 ? (
              <Carousel showThumbs={false} dynamicHeight={false} showStatus={true} infiniteLoop>
          ...
          <div className="col-lg-6 col-md-6 col-sm-10 col-xs-10 mt-3">
            ...
            <button className="btn btn-dark" onClick={() => setShowModal(true)}><i className="bi bi-pencil-fill me-2"></i>Edit Car</button>
          </div>
        </div>
      ) : (
        <h2>Car not found</h2>
